...
const one = promisifiedReadFile('poem-one/stanza-01.txt')
const two = promisifiedReadFile('poem-one/stanza-02.txt')
const three = promisifiedReadFile('poem-one/stanza-03.txt')
const four = promisifiedReadFile('poem-one/stanza-04.txt')
